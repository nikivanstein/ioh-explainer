...
cma_features = ['covariance', 'elitist', 'mirrored', 'base_sampler', 'weights_option', 'local_restart', 'step_size_adaptation', 'lambda_', 'mu']
steps_dict = {
}
...
de_features = ['F','CR', 'lambda_', 'mutation_base', 'mutation_reference',
